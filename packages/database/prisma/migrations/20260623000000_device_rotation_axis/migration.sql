...
ALTER TABLE "devices" ADD COLUMN "rotation" INTEGER NOT NULL DEFAULT 0;

-- 2. Derive rotation from the legacy orientation value.
UPDATE "devices" SET "rotation" = CASE "orientation"
...
UPDATE "devices" SET "orientation" = 'landscape' WHERE "orientation" = 'inverted_landscape';
UPDATE "devices" SET "orientation" = 'portrait' WHERE "orientation" = 'inverted_portrait';
...
ALTER TABLE "devices" ALTER COLUMN "orientation" SET DEFAULT 'landscape';
